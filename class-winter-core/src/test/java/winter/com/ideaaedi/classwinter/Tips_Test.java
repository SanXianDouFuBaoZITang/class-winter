...
//        test0();
    ...
    public static void test0() {
        ...
        String startBat = "java -jar " + projectRootDir + "class-winter-core-2.9.6.jar"
    ...
    public static void test1() {
        ...
        // java -jar class-winter-core-2.9.6.jar originJarOrWar=/boot-jar.jar includePrefix=com tips="[潘嘎之交] 潘: 你别怪潘叔说话比较直白, 网络上的东西都是虚拟的, 你把握不住, 孩子! 因为这里的水很深..."
        String startBat = "java -jar " + projectRootDir + "class-winter-core-2.9.6.jar"
                + " originJarOrWar=" + originJarOrWar
                + " includePrefix=" + includePrefix
